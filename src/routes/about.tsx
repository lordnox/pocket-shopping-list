import { H1, H2, Main, P } from '~/components/Basics'
...
export default function About() {
  return (
    <Main>
      ...
      <P>
        Wir wollen damit die für uns, und auch gerne andere, damit senken. Eine Anbindung an Einkaufslisten ist denkbar,
        eventuell eine direkte Bestellung bei Onlineshops.
      </P>
